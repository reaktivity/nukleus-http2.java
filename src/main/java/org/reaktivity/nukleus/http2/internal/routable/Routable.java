...
import static org.reaktivity.nukleus.http2.internal.routable.Route.sourceMatches;
import static org.reaktivity.nukleus.http2.internal.routable.Route.sourceRefMatches;
import static org.reaktivity.nukleus.http2.internal.routable.Route.targetMatches;
import static org.reaktivity.nukleus.http2.internal.routable.Route.targetRefMatches;
...
public final class Routable extends Nukleus.Composite
{
        ...
        String partitionName)
    {
        ...
        return include(new Source(sourceName, partitionName, layout, writeBuffer,
                                  ...
                                  context.maximumSlots(), context.window()));
    }
